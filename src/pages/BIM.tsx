...
import { Box, LayoutDashboard, Eye, AlertTriangle, Database, History, Shield, Droplets } from 'lucide-react';
...
const NAV_ITEMS: { screen: Screen; label: string; icon: React.ReactNode; group: string; badge?: number }[] = [
  ...
  { screen: 'viewer',    label: 'Visor interactivo',  icon: <Eye size={15} />,             group: 'Principal' },
  { screen: 'alerts',    label: 'Alertas BIM',        icon: <AlertTriangle size={15} />,   group: 'Operación', badge: 5 },
